...
/**
 * Generated class for the LoyaltyaddPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-loyaltyadd',
  templateUrl: 'loyaltyadd.html',
})
export class LoyaltyaddPage {
 ...
 public id:any;
  ...
  constructor(public navCtrl: NavController, 
    ...
    onSubmit(formData) {
      ...
      this.storage.get('uid').then(val => {
       ...
       this.authService.loyaltyadd(formData).subscribe(res=>{
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LoyaltyaddPage');
  }
